...
export default function Home() {
  ...
  return (
    <div style={{background:"#fafafa", minHeight:"100vh", fontFamily:"Noto Sans JP,sans-serif"}}>
      ...
      <nav style={{
        ...
        <div style={{display:"flex", alignItems:"center", gap:"8px"}}>
          <Link href="/login" style={{padding:"6px 14px", borderRadius:"12px", border:"1px solid var(--border)", color:"var(--ink2)", fontSize:"12px", fontWeight:600, textDecoration:"none"}}>
            ログイン
          </Link>
          <Link href="/signup" style={{padding:"7px 16px", borderRadius:"12px", background:"#f97066", color:"#fff", fontSize:"12px", fontWeight:700, textDecoration:"none"}}>
            無料登録
          </Link>
        </div>
      </nav>
      ...
      <section style={{
        ...
        <div style={{position:"relative", zIndex:1, maxWidth:"900px", margin:"0 auto"}}>
          ...
          <h1 style={{fontFamily:"Zen Maru Gothic,sans-serif", fontSize:"clamp(32px,4.5vw,56px)", fontWeight:700, color:"var(--ink)", lineHeight:1.2, marginBottom:"16px"}}>
            総合型選抜の<br/>
            <span style={{background:"linear-gradient(135deg,#0d9488,#22d3ee)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent"}}>「わからない」</span>を<br className="sm:hidden" />
            ゼロにする。
          </h1>
      ...
      <section style={{padding:"0 24px 80px", maxWidth:"960px", margin:"0 auto"}}>
        <div className="lp-two-cols" style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:"20px"}}>
          ...
          <div style={{
            ...
            borderRadius:"24px", padding:"36px 28px", position:"relative", overflow:"hidden",
            ...
            <h2 style={{fontFamily:"Zen Maru Gothic,sans-serif", fontSize:"22px", fontWeight:700, color:"var(--ink)", lineHeight:1.3, marginBottom:"12px"}}>
              大学を比較して<br/>受験を整理する
            </h2>
            ...
            <div style={{display:"flex", flexDirection:"column", gap:"10px", marginBottom:"28px", flex:1}}>
              {[
                ...
                <div key={i} style={{display:"flex", gap:"10px", alignItems:"flex-start"}}>
                  <span style={{fontSize:"24px", minWidth:"32px", marginTop:"1px"}}>{f.icon}</span>
                  <div>
            ...
            <Link href="/simulator" style={{
              ...
              border:"2px solid #f97066", background:"transparent",
              color:"#f97066", fontSize:"15px", fontWeight:700,
          ...
          <div style={{
            ...
            <div style={{position:"relative", zIndex:1, display:"flex", flexDirection:"column", flex:1}}>
              ...
              <h2 style={{fontFamily:"Zen Maru Gothic,sans-serif", fontSize:"22px", fontWeight:700, color:"#fff", lineHeight:1.3, marginBottom:"12px"}}>
        ...
        {/* 統計バー */}
        <div className="grid grid-cols-2 md:grid-cols-4" style={{marginTop:"32px", border:"1px solid var(--border)", borderRadius:"20px", background:"var(--surface)", overflow:"hidden", boxShadow:"var(--sh)"}}>
      ...
      <section style={{background:"var(--surface2)", borderTop:"1px solid var(--border)", borderBottom:"1px solid var(--border)", padding:"60px 24px"}}>
        <div style={{maxWidth:"800px", margin:"0 auto", textAlign:"center"}}>
          ...
          <h2 style={{fontFamily:"Zen Maru Gothic,sans-serif", fontSize:"clamp(24px,3vw,32px)", fontWeight:700, color:"var(--ink)", lineHeight:1.3, marginBottom:"48px"}}>3ステップで、受験の全体像が見える</h2>
          ...
          <div style={{marginTop:"32px"}}>
            <Link href="/simulator" style={{display:"inline-block", padding:"14px 40px", borderRadius:"12px", border:"2px solid #f97066", color:"#f97066", fontSize:"15px", fontWeight:700, textDecoration:"none"}}>
              今すぐ無料で試す →
            </Link>
          </div>
        </div>
      ...
      <section style={{padding:"80px 24px", maxWidth:"1100px", margin:"0 auto"}}>
        <div className="lp-two-cols" style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:"40px", alignItems:"center"}}>
          <div>
            ...
            <h2 style={{fontFamily:"Zen Maru Gothic,sans-serif", fontSize:"clamp(24px,2.5vw,34px)", fontWeight:700, color:"var(--ink)", lineHeight:1.3, marginBottom:"16px"}}>
            ...
            <Link href="/signup" style={{display:"inline-block", padding:"13px 28px", borderRadius:"12px", background:"#f97066", color:"#fff", fontSize:"14px", fontWeight:700, textDecoration:"none"}}>
              保護者として登録する →
            </Link>
          </div>
          <div style={{background:"linear-gradient(135deg,var(--teal3),var(--teal2))", borderRadius:"24px", padding:"32px", color:"#fff", position:"relative", overflow:"hidden"}}>
      ...
      <section style={{background:"var(--surface2)", borderTop:"1px solid var(--border)", padding:"80px 24px"}}>
        <div style={{maxWidth:"1100px", margin:"0 auto", textAlign:"center"}}>
          ...
          <h2 style={{fontFamily:"Zen Maru Gothic,sans-serif", fontSize:"clamp(26px,3vw,36px)", fontWeight:700, color:"var(--ink)", marginBottom:"48px"}}>受験生・保護者から届いた声</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} style={{background:"var(--surface)", border:"1.5px solid var(--border)", borderRadius:"20px", padding:"24px", boxShadow:"var(--sh-sm)", textAlign:"left"}}>
      ...
      <section style={{padding:"80px 24px", textAlign:"center"}}>
        <div style={{maxWidth:"600px", margin:"0 auto"}}>
          <h2 style={{fontFamily:"Zen Maru Gothic,sans-serif", fontSize:"clamp(28px,3vw,40px)", fontWeight:700, color:"var(--ink)", lineHeight:1.3, marginBottom:"16px"}}>
            まずは無料で、<br/>試してみませんか。
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center flex-wrap items-center">
            <Link href="/simulator" style={{padding:"15px 32px", borderRadius:"12px", border:"2px solid #f97066", color:"#f97066", fontSize:"15px", fontWeight:700, textDecoration:"none", display:"inline-block"}}>
              🔍 無料で試す →
            </Link>
            <Link href="/signup" style={{padding:"15px 36px", borderRadius:"12px", background:"linear-gradient(135deg,#f97066,#fb923c)", color:"#fff", fontSize:"15px", fontWeight:700, textDecoration:"none", display:"inline-block", boxShadow:"0 8px 24px rgba(249,112,102,.25)"}}>
              ✦ プレミアムで始める
            </Link>
          </div>
        </div>
